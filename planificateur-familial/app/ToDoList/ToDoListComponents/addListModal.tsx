...
import { createTodoList } from "../ToDoListController"; // Mettez à jour l'import
import AddMembersModal from "./addMembersModal"; // Mettez à jour l'import
...
const AddListModal: React.FC<AddListModalProps> = ({ modalVisible, setModalVisible }) => {
    ...
    const handleCreateList = async () => {
        ...
        try {
            ...
            const listId = await createTodoList(listName, membersList, user);
            if (listId) {
